...
f = io.imread('testData/TestS1.GIF')   # read in image
...
ax1.imshow( np.log( Magq +1 ), cmap='gray' ) # io. #plots magnitude
print(sum(Magq[200,:])/640) #avg along middle row
#draw figure from fourier transform
